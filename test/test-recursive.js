...
test("test: mkdir /new-path2 && put /new-path2/file.txt", function(t) {
    ...
    setTimeout(function() {
        ...
        t.equal(fs.existsSync(dst_dir+"/new-path2/file.txt"), true, "file /new-path2/file.txt created");
        t.end();
    }, g_timeout);
});
...
test("test: paste test", function(t) {
    ...
    setTimeout(function() {
        ...
        t.equal(fs.existsSync(dst_dir+"/paste-path/path2"), true, "paste: /paste-path/path2");
        t.equal(fs.existsSync(dst_dir+"/paste-path/file.txt"), true, "paste: /paste-path/file.txt");
        t.equal(fs.existsSync(dst_dir+"/paste-path/path2/file.txt"), true, "paste: /paste-path/path2/file.txt");
        t.end();
    }, g_timeout);
});
test("test: rename all paste (1/5)", function(t) {
    ...
    setTimeout(function() {
        ...
        t.equal(fs.existsSync(dst_dir+"/paste-path/renamed.txt"), true, "file /paste-path/file.txt found");
        t.end();
    }, g_timeout);
});
...
test("test: rename all paste (2/5)", function(t) {
    ...
    setTimeout(function() {
        ...
        t.equal(fs.existsSync(dst_dir+"/paste-path/path2/renamed.txt"), true, "file /paste-path/path2/renamed.txt found");
        t.end();
    }, g_timeout);
});
...
test("test: rename all paste (3/5)", function(t) {
    ...
    setTimeout(function() {
        ...
        t.equal(fs.existsSync(dst_dir+"/paste-path/path2-renamed"), true, "directory /paste-path/path2-renamed found");
        t.end();
    }, g_timeout);
});
...
test("test: rename all paste (4/5)", function(t) {
    ...
    setTimeout(function() {
        ...
        t.equal(fs.existsSync(dst_dir+"/paste-path/path2-renamed/file.txt"), true, "file /paste-path/path2-renamed/file.txt found");
        t.end();
    }, g_timeout);
});
...
test("test: rename all paste (5/5)", function(t) {
    ...
    setTimeout(function() {
        t.equal(fs.existsSync(dst_dir+"/paste-path/path2-renamed/renamed.txt"), true, "file /paste-path/path2-renamed/renamed.txt found");
